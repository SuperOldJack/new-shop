  ...
  <TR>
    <TD><BR>
      <FORM onKeyPress="if(event.keyCode==13){return false;}" name=sample 
       method=post>
      <DIV align=center><SPAN class=style1>销售订单</SPAN></DIV><INPUT id=rowcount 
      type=hidden name=rowcount> <INPUT id=_check type=hidden value=false 
      name=_check> 
      <DIV align=center><SPAN class=style1><LABEL 
      id=tittle_lable>XD-2010-04-15-0001</LABEL><INPUT id=billcode_input 
      type=hidden value=XD-2010-04-15-0001 name=billcode></SPAN></DIV><BR>
      ...
      bgColor=#ffffee borderColorLight=#000000 border=1>
        ...
        <TR>
          ...
          <TD><SELECT id=depot name=depot><OPTION value=1 
        ...
        <TR>
          ...
          <TD><INPUT onKeyDown="" size=30 name=memo></TD>
        ...
        <TR>
          ...
          <TD><SELECT name=account><OPTION value="" selected></OPTION> 
              <OPTION value=¹¤ÉÌÒøÐÐ>¹¤ÉÌÒøÐÐ</OPTION><OPTION 
              value=Å©ÒµÒøÐÐ>Å©ÒµÒøÐÐ</OPTION><OPTION 
        value=111>111</OPTION></SELECT></TD></TR></TBODY></TABLE>
      <DIV class=but_mar><INPUT class=button onclick=add_row() type=button value="添 加" name=add> 
<INPUT class=button onclick=del_row() type=button value="删 除" name=del> 
      ...
      <DIV class=but_mar align=center><INPUT class=button onmousedown=checkbill(); onClick="return check();" type=submit value="创  建" name=B1></DIV></FORM></TD></TR></TBODY></TABLE></BODY></HTML>
