...
function initPage() {
	...
	var menuArr = [
			...
			{//销售管理 	
				...
				"urls":["addSell","findSell?currentPageNo=0","sellRturn?currentPageNo=0","sellDetail?currentPageNo=0","sellSummary?currentPageNo=0","CSellSummary?currentPageNo=0","sellOrderStatus"]
			},
			{//库存管理
